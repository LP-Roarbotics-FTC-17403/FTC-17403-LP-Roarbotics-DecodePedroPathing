...
public class BlueSidePedroPathing_v2 extends OpMode {
    ...
    private final Pose startPose = new Pose(33.94219653179191, 133.8959537572254, Math.toRadians(90));
    ...
    public void buildPaths(){
        readAprilTag = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(33.94219653179191, 133.8959537572254),
